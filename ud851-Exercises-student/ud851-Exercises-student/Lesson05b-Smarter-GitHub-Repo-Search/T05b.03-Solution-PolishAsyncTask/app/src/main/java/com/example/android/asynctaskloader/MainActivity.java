...
public class MainActivity extends AppCompatActivity implements
    ...
    private void makeGithubSearchQuery() {
        ...
        if (githubSearchLoader == null) {
            Log.i("CHECK","Create new githubSearchLoader");
            loaderManager.initLoader(GITHUB_SEARCH_LOADER, queryBundle, this);


        } else {
            Log.i("CHECK","Reload existing githubSearchLoader");
    ...
    public Loader<String> onCreateLoader(int id, final Bundle args) {
        return new AsyncTaskLoader<String>(this) {
            ...
            protected void onStartLoading() {
                ...
                Log.i("CHECK","WE ARE IN onStartLoading() ");
                if (mGithubJson != null) {
                    Log.i("CHECK","WE ARE IN onStartLoading() | CACHED JSON :" + mGithubJson);
                    ...
                    Log.i("CHECK","WE ARE IN onStartLoading() | NO CACHED JSON ");
                    forceLoad();
            ...
            public String loadInBackground() {
                Log.i("CHECK","WE ARE IN loadInBackground ()| CACHED JSON : " + mGithubJson);
            ...
            public void deliverResult(String githubJson) {
                Log.i("CHECK","WE ARE IN deliverResult ()| CACHED JSON : " + mGithubJson);
                mGithubJson = githubJson;
                Log.i("CHECK","WE ARE IN deliverResult ()| CACHED JSON2 : " + mGithubJson);
                super.deliverResult(githubJson);
                Log.i("CHECK","WE ARE IN deliverResult ()| CACHED JSON3 : " + mGithubJson);
            }
        };
    }
