...
import com.example.android.todolist.InjectorUtils;
...
public class AddTaskActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AddTaskViewModelFactory factory = InjectorUtils.provideAddTaskViewModelFactory(this,mTaskId);
    ...
    public void onSaveButtonClicked() {
        ...
        if (mTaskId == DEFAULT_TASK_ID) {
            // insert new task
            viewModel.getRepository().insertTask(task);
        } else {
            //update task
            task.setId(mTaskId);
            viewModel.getRepository().updateTask(task);
        }
        finish();
    }
