...
public class NotificationUtils {
    //ITOGO:  NotificationManager HAS submitted NotificationChannel HAS Notifications(NotificationCompat.Builder)
    // HAS : 1)Actions CREATED FROM PendingIntent CREATED FROM Intent(Can launch new activity , service etc) ;
    //      2)ContentIntent USED BY NotificationManager CREATED FROM PendingIntent CREATED FROM Intent
    //
    //
    /*
    ...
    private static Action ignoreReminderAction(Context context) {
        ...
        //
        //
        //Создаем обычный интент - передали класс того чего хотим сделать : запустить сервис,активити и тд
        //
        //
        //**
        ...
        //
        //
        //Устанавливаем действие - поле интента (Стринг обычный крче)
        ...
        //
        //
        // Делаем спец интент который может быть вызван из вне приложения разными систем менеджерами
        // ( в данном случае NotificationManager) : он принимает 1) Контекст ; 2) Айди ПЕНДИНГ интента ; 3) Обычный интент
        // то есть тот интент, где и описывается сама суть действия, здесь это запуск ИнтентСервиса(Обыч сервис ,но при это
        // делает свою работу в отдельном от UI потоке); 4)Флаг - пока неоч понятно зачем и что ~ устанавливает поведение и доп
        //фичи интента
        ...
        //
        //
        //Сам объект Action - тыкалка на экране нотификейшена : 1) картинка 2)Тайтл 3) Пендинг интент :
