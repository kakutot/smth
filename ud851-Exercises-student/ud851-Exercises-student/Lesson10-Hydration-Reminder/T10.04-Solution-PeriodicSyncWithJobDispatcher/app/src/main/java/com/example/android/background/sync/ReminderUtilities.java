...
//ITOGO
// Сделали отдельный класс-наследник от JobService - сервис (по умолчанию также работает в главном потоке),
// переопределили doInBackground() - показали нотификейшен,поменяли tv в UI, onPostExecute() - просто
// jobFinished(jobParameters, false);
// Здесь делаем объект FirabaseDispatcher ,объект Job (установили ему параметры,один из них - наш кастомный сервис)
// Начинаем скедулить наш Job через schedule(Job job)
