...
public class ReminderTasks {
    ...
    public static final String ACTION_ISSUE_CHARGER = "issue-charger";
    public static void executeTask(Context context, String action) {
        ...
        else if (ACTION_ISSUE_CHARGER.equals(action)) {
          issueChargerReminder(context);
        }
    }
    ...
    private static void issueChargerReminder(Context context){
